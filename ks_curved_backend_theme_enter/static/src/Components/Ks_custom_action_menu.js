odoo.define('ks_curved_backend_theme_enter.Ks_custom_action_menu.js', function (require) {
    "use strict";
    ...
    const KsDropdownMenu = require('ks_curved_backend_theme_enter.KsDropdownMenu');
    ...
    KsActionMenus.template = 'ks_curved_backend_theme_enter.KsActionMenus';
