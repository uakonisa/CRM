odoo.define("ks_curved_backend_theme_enter.ks_fullscreen", function(require) {
    "use strict";
    ...
    ControlPanel.patch("ks_curved_backend_theme_enter.ks_fullscreen", (T)=>class extends T {
        constructor() {
            super(...arguments);
